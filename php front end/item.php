                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                       <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="filter.php">Filter <span class="sr-only"></span></a> </li>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="filter.php">Choose Filter</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="item.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite antique</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Order </a></li>
                        
                    </ul>
                </div>
            </div>
			<?php $ress= mysqli_query($db,"select * from filter where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="/vintage/images/img/back.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="item.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              List <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  
									$stmt = $db->prepare("select * from item where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='item.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/item/'.$product['img'].'" alt="logo">'; ?></a>
                                            </div>
