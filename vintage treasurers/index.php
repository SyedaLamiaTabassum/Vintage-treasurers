...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="filter.php">Filters <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="/vintage/images/img/back.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Vintage Treasurers</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Your Antique</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Place Order</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Deliverd at your home</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Antiques of the Month</h2>
                    <p class="lead">Easiest way to order your favourite Antique among these top 6 </p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from item LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                        
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="admin/Res_img/item/'.$r['img'].'"></div>
                                                <div class="content">
                                                    <h5><a href="item.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="item.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from filter");  
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="item.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt=" logo"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="item.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
